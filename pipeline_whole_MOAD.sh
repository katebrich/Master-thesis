...
dataset_train_name="${dataset_train_name_short}_filter_MOAD"
...
dataset_test_name="${dataset_test_name_short}_filter_MOAD"
...
dataset_eval_name="${dataset_eval_name_short}_filter_MOAD"
