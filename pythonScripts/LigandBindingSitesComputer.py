...
class LigandBindingSitesComputer():
    ...
    def __init__(self, dataset_file, output_dir, mappings_dir, PDB_dir, threshold=4):
    ...
    def filter_ligands(self, ligands, AAs, pdb_id, chain_id):
        result = []
        skipped = []
        small = []
        center_far = []
    ...
    def compute_ligand_binding_sites(self, pdb_id, chain_id, pdb_file_path):
        ...
        ligands = self.filter_ligands(ligands_all, AAs, pdb_id, chain_id)
        ...
        for AA in AAs:
            ...
            for ligand in ligands:
                if (isInDistance(self.threshold, AA, ligand)):
