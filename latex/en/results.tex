...
\end{tabular}
\caption{Comparison of the performance of models with different sets of features: P2Rank default features (baseline model), csv features and both sets together.}
