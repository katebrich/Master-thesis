...
experiment_name="noCustom_noAvg"
threads=4
loops=1
...
#features_list="lbs,helix,strand,turn,hydropathy,charged,aromaticity,mol_weight,H_bond_atoms,HSE_up,HSE_down,exposure_CN,bfactor,pdbekb_conservation,dynamine,efoldmine,depth,mobiDB,phi_angle,psi_angle,conservation,aa_ALA,aa_CYS,aa_ASP,aa_GLU,aa_PHE,aa_GLY,aa_HIS,aa_ILE,aa_LYS,aa_LEU,aa_MET,aa_ASN,aa_PRO,aa_GLN,aa_ARG,aa_SER,aa_THR,aa_VAL,aa_TRP,aa_TYR"
...
#	#python3 ${python_scripts_path}create_p2rank_custom_feature_files.py -d $dataset_eval2_file -i $data_eval2_dir -o $data_eval2_dir/P2Rank/$feature -t $threads -f $feature
...
##cp $data_eval2_dir/P2Rank/$feature/*.csv ${P2Rank_path}/custom_feature/ || true
...
bash ${P2Rank_path}/p2rank/prank traineval -t $dataset_prank_train -e $dataset_prank_eval \
	...
	-classifier FastRandomForest -feature_importances 1 || true
