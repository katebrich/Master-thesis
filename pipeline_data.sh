...
dataset_train_file="${main_folder}/datasets/${dataset_train_name}_filter_p2rank.txt"
data_train_dir="${P2Rank_path}/datasets/${experiment_name}/${dataset_train_name}"
...
dataset_train_file="${main_folder}/datasets/${dataset_train_name}_filter_MOAD.txt"
data_train_dir="${P2Rank_path}/datasets/${experiment_name}/${dataset_train_name}"
